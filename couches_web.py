...
le DataFrame est enregistrées en couche shapefile (.shp) et 
les données sont mise à jour sur ArcGIS Onlie. 

Information supplémentaire : 
----------------------------
    sedf : https://developers.arcgis.com/python/guide/introduction-to-the-spatially-enabled-dataframe/
    editing features : https://developers.arcgis.com/python/guide/editing-features/
    append features  : https://developers.arcgis.com/python/guide/appending-features/
    update features  : https://developers.arcgis.com/python/sample-notebooks/updating-features-in-a-feature-layer/#Apply-edits-from-third-spreadsheet
    arcgis dashboard : https://doc.arcgis.com/fr/dashboards/get-started/serial-chart.htm
"""
...
class CoucheWeb():
    ...
    def __init__(self, station, repertoire):
        ...
        data_frame (DataFrame) : Tableau de données à jour avec la température de l'air et le cumul de degrés-jour (SILA, Salluit) ou la température du sol (GN et GS); 
        indices_clim (DataFrame): Tableau de données avec les indices climatiques à jours;
        ...
        self.gis = GIS(username = 'CEN.AGOL_ulaval', password = 'cen1234.')
...
# =============================================================================
    ...
    def mise_a_jour_couches(self): 
        """
        Méthode principale qui fait appels aux méthodes nécessaires pour 
        ...
        """
        # Récupérer les nouvelles données à publiées
...
# =============================================================================
    ...
    def nouvelles_donnees(self):
        """
        Méthode pour identifier les nouvelles lignes à publiées sur le Web. 
        """
        try: 
...
# =============================================================================
            ...
            if self.nouvelles_lignes.empty:
                print('Aucune nouvelles données à publier.', end = '\n\n')
    ...
    def colonnes_geometrie(self):
        ...
        # Coordonnée géographiques selon la station en entrée
        if self.station == 'Station SILA': 
...
# =============================================================================
        ...
        # Gestion des erreurs possibles
            ...
            print('COUCHE WEB INDICES CLIMATIQUES : Nom du fichier incorrecte.Entrez un autre nom en argument ou vérifier le répertoire.')
    ...
    def derniere_donnees_disponibles(self):
        ...
        try: 
            ...
            print('COUCHE WEB : Nom du fichier incorrecte.Entrez un autre nom en argument ou vérifier le répertoire.')
    ...
    def enregistre_shapefile(self):
        ...
        # Gestion des erreurs possibles
            ...
            print('SHAPEFILE : Nom incorrecte. Entrez un autre nom en argument ou vérifier le répertoire.')
            
        except FileNotFoundError:
            print('SHAPEFILE : Fichier introuvable. Essayez un autre nom ou vérifier dans le répertoire.')
