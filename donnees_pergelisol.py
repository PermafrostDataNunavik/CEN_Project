...
et pour récupérer les données journalière à distance sur le serveur FTP-CEN. 

Les données de température du sol moyennes journalières utilisées pour la période antérieures 
à 2017 sont les données traités dans le cadre de la publication : 
...
# =============================================================================
    ...
    def moyenne_journaliere(self):
        ...
        # Dernière date dans le fichier avec les moyennes journalière
...
# =============================================================================
    ...
    def stats_df_total(self):
        ...
        par profondeur pour une période de temps données, soit par année climatique. 
        """
...
# =============================================================================
        ...
        for i in range(len(df_annee_clim)):
            ...
            for i in df_date[self.profondeur]:
                ...
                # Est-ce que le pourcentage de valeurs manquantes est supérieurs à la limite acceptée
    ...
    def tableau_donnees(self):
        ...
        ---------------------------
        self.gn_serveur (DataFrame) : Tableau de données avec les données bruttes
    ...
    def nouvelles_donnees_serveur(self): 
        ...
        ---------------------------
        self.gn_clean (DataFrame) : Fichier de données pré-nettoyé
        ...
        try:
            ...
            # S'il n'y a pas de nouvelles données
                ...
                print(Back.MAGENTA + f'Aucune nouvelles données dans {self.station}.'  + Style.RESET_ALL, end = '\n\n')
    ...
    def ecriture_donnees_sol(self, data_frame, fichier):
        """
        Méthode pour écrire les nouvelles données journalière à la fin du fichier. 
        """
        try: 
            ...
            if not data_frame.empty : 
                ...
                print(f'Aucune nouvelles données à écrire. Lecture du fichier de la {self.station} terminée.', end = '\n\n')
...
if __name__ == '__main__':
    ...
    # station.stats_df_total()
    # station.min_max.to_excel('Station_Data/GS/Excel/GS_min_max.xlsx',index = False)
