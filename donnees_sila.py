...
# =============================================================================
    ...
    # =============================================================================
            ...
            # Aller chercher les bonnes données dans la page SILA
            date_jour = (datetime.today() - timedelta(days=1)).date()
            premier_jour = datetime(date_jour.year, date_jour.month, 1).date()
            dernier_jour = (datetime(date_jour.year, date_jour.month, 1) + relativedelta(months=1, days=-1)).date()
    
            # Si la date d'hier est le premier jour du mois   
            if date_jour == premier_jour:
                df_mensuelles = self.df_mois.iloc[[0]]
            
            # Si la date d'hier est le dernier jour du mois   
            if date_jour == dernier_jour: 
    ...
    def donnees_site_web_melcc(self):
        ...
        try: 
            ...
            # Aller chercher le bon mois dans la page SILA
            ...
            self.df_mois['Annee'] = date.year
            self.df_mois['Mois'] = date.month
            ...
            print('Données MELCC : Aucune nouvelles données.')
...
if __name__ == '__main__':
    ...
    objet_sila = DonneesSila()
    DonneesSila.donnees_sila(objet_sila)
    
    df_sila = objet_sila.df_sila
